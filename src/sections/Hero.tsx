...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <section
      id="home"
      className="flex flex-col-reverse items-center p-10 lg:items-stretch lg:grid lg:grid-cols-3 h-fit w-svw bg-theme"
    >
      ...
      <div className="relative flex flex-col items-center justify-center m-10 duration-150 size-fit">
        <img
          tabIndex={2}
        ...
        <div
          tabIndex={0}
          className="absolute z-10 duration-150 bg-theme-invert rounded-full size-2 peer-hover:size-64"
        ></div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center text-xl leading-loose text-center duration-150 lg:px-1 lg:items-baseline lg:text-left text-pretty line-clamp-3">
        ...
        <span className="block my-4 text-base lg:text-lg hover-target ">
          Hi, I’m {fullname}—{shortname} for short! As an undergraduate at Semarang State Polytechnic, I’m driven by a love for learning, a hunger for challenges, and a passion for helping others. Let’s grow and achieve great things together!
        </span>
      </div>
    </section>
  );
